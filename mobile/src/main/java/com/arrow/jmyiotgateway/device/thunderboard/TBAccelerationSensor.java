...
public final class TBAccelerationSensor extends BleSensorAbstract<TBVectorData> {
    public TBAccelerationSensor(BluetoothDevice device, BluetoothGattService service) {
    ...
    public UUID getDataUUID() {
        return ThunderBoardUuids.UUID_CHARACTERISTIC_ACCELERATION;
    }
