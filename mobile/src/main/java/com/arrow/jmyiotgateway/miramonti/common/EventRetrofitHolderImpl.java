 ...
 */
public class EventRetrofitHolderImpl implements EventRetrofitHolder {
    @NonNull
    ...
    public EventRetrofitHolderImpl(ExecutorService httpRequestsExecutor) {
        Timber.v("EventRetrofitHolderImpl: ");
    ...
    @Override
    public EventIotConnectApiService getIotConnectAPIService(@NonNull String endpoint) {
        ...
        return mRetrofit.create(EventIotConnectApiService.class);
    }
